...
// (https://wiki.libsdl.org/SDL2/SDL_CreateMutex)
...
// (https://wiki.libsdl.org/SDL2/SDL_LockMutex)
...
// (https://wiki.libsdl.org/SDL2/SDL_TryLockMutex)
...
// (https://wiki.libsdl.org/SDL2/SDL_DestroyMutex)
func (mutex *Mutex) Destroy() {
	C.SDL_DestroyMutex(mutex.cptr())
}

// CreateSemaphore creates a semaphore.
// (https://wiki.libsdl.org/SDL2/SDL_CreateSemaphore)
...
// (https://wiki.libsdl.org/SDL2/SDL_DestroySemaphore)
...
// (https://wiki.libsdl.org/SDL2/SDL_SemWait)
...
// (https://wiki.libsdl.org/SDL2/SDL_SemTryWait)
...
// (https://wiki.libsdl.org/SDL2/SDL_SemWaitTimeout)
...
// (https://wiki.libsdl.org/SDL2/SDL_SemPost)
...
// (https://wiki.libsdl.org/SDL2/SDL_CondSignal)
...
// (https://wiki.libsdl.org/SDL2/SDL_CondBroadcast)
...
// (https://wiki.libsdl.org/SDL2/SDL_CondWait)
...
// (https://wiki.libsdl.org/SDL2/SDL_CondWaitTimeout)
