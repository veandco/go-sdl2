...
//#cgo linux,arm6 LDFLAGS: -lSDL2_linux_arm64 -lm -ldl -lasound -lm -ldl -lpthread -lX11 -lXext -lXcursor -lXinerama -lXi -lXrandr -lXss -lXxf86vm -lpthread -lrt
...
//#cgo linux,arm64 LDFLAGS: -lSDL2_linux_arm64 -lm -ldl -pthread
import "C"
import (
