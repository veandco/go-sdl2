...
// Init initializes the truetype font API. This must be called before using other functions in this library, except WasInit().
// (https://www.libsdl.org/projects/SDL_ttf/docs/SDL_ttf_8.html#SEC8)
func Init() error {
	if C.TTF_Init() == -1 {
		return GetError()
	}
...
// WasInit reports whether the truetype font API is initialized. Use this before Init() to avoid initializing twice in a row. Or use this to determine if you need to call Quit().
// (https://www.libsdl.org/projects/SDL_ttf/docs/SDL_ttf_9.html#SEC9)
func WasInit() bool {
	return int(C.TTF_WasInit()) != 0
}

// Quit shuts down and cleanups the truetype font API.
// (https://www.libsdl.org/projects/SDL_ttf/docs/SDL_ttf_10.html#SEC10)
func Quit() {
	C.TTF_Quit()
}
...
// (https://www.libsdl.org/projects/SDL_ttf/docs/SDL_ttf_12.html#SEC12)
func GetError() error {
	e := C.TTF_GetError()
	if e == nil {
		return nil
...
// (https://www.libsdl.org/projects/SDL_ttf/docs/SDL_ttf_11.html#SEC11)
...
// (https://www.libsdl.org/projects/SDL_ttf/docs/SDL_ttf_20.html#SEC20)
...
// (https://www.libsdl.org/projects/SDL_ttf/docs/SDL_ttf_14.html#SEC14)
...
// (https://www.libsdl.org/projects/SDL_ttf/docs/SDL_ttf_16.html#SEC16)
...
// (https://www.libsdl.org/projects/SDL_ttf/docs/SDL_ttf_15.html#SEC15)
...
// (https://www.libsdl.org/projects/SDL_ttf/docs/SDL_ttf_17.html#SEC17)
...
// (https://www.libsdl.org/projects/SDL_ttf/docs/SDL_ttf_44.html#SEC44)
...
// (https://www.libsdl.org/projects/SDL_ttf/docs/SDL_ttf_48.html#SEC48)
...
// (https://www.libsdl.org/projects/SDL_ttf/docs/SDL_ttf_52.html#SEC52)
...
// SizeUTF8 returns the resulting surface size (width and height) of the UTF8 encoded text rendered using font. No actual rendering is done, however correct kerning is done to get the actual width. The height returned in h is the same as you can get using FontHeight().
// (https://www.libsdl.org/projects/SDL_ttf/docs/SDL_ttf_40.html#SEC40)
...
// (https://www.libsdl.org/projects/SDL_ttf/docs/SDL_ttf_18.html#SEC18)
func (f *Font) Close() {
	C.TTF_CloseFont(f.f)
	f.f = nil
}
...
// (https://www.libsdl.org/projects/SDL_ttf/docs/SDL_ttf_29.html#SEC29)
...
// (https://www.libsdl.org/projects/SDL_ttf/docs/SDL_ttf_30.html#SEC30)
...
// (https://www.libsdl.org/projects/SDL_ttf/docs/SDL_ttf_31.html#SEC31)
...
// (https://www.libsdl.org/projects/SDL_ttf/docs/SDL_ttf_32.html#SEC32)
...
// (https://www.libsdl.org/projects/SDL_ttf/docs/SDL_ttf_25.html#SEC25)
func (f *Font) GetHinting() int {
	return int(C.TTF_GetFontHinting(f.f))
}

// SetHinting sets the hinting of the loaded font.
// (https://www.libsdl.org/projects/SDL_ttf/docs/SDL_ttf_26.html#SEC26)
...
// (https://www.libsdl.org/projects/SDL_ttf/docs/SDL_ttf_27.html#SEC27)
...
// (https://www.libsdl.org/projects/SDL_ttf/docs/SDL_ttf_28.html#SEC28)
...
// (https://www.libsdl.org/projects/SDL_ttf/docs/SDL_ttf_23.html#SEC23)
func (f *Font) GetOutline() int {
	return int(C.TTF_GetFontOutline(f.f))
}

// SetOutline sets the outline pixel width of the loaded font.
// (https://www.libsdl.org/projects/SDL_ttf/docs/SDL_ttf_24.html#SEC24)
...
// (https://www.libsdl.org/projects/SDL_ttf/docs/SDL_ttf_34.html#SEC34)
...
// (https://www.libsdl.org/projects/SDL_ttf/docs/SDL_ttf_35.html#SEC35)
