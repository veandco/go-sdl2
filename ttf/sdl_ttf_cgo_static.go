...
//#cgo darwin,arm64 LDFLAGS: -lSDL2_ttf_darwin_arm64 -lm -liconv -lfreetype_darwin_arm64 -lSDL2_darwin_arm64 -Wl,-framework,CoreAudio -Wl,-framework,AudioToolbox -Wl,-framework,ForceFeedback -lobjc -Wl,-framework,CoreVideo -Wl,-framework,Cocoa -Wl,-framework,Carbon -Wl,-framework,IOKit -Wl,-framework,Metal
