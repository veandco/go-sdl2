...
1. Install mingw-w64 from [Mingw-builds](http://mingw-w64.org/doku.php/download/mingw-builds)
    * Version: latest (at time of writing 8.1.0)
    * Architecture: x86_64
    * Threads: win32
    * Exception: seh
    * Build revision: 0
    * Destination Folder: Select a folder that your Windows user owns
2. Download `SDL2-devel-2.0.10-mingw.tar.gz` from http://libsdl.org/download-2.0.php
    * Extract the SDL2 folder from the archive using a tool like [7zip](http://7-zip.org)
    * Copy contents of the `i686-w64-mingw32` and/or `x86_64-w64-mingw32` depending on the architecture you chose into your mingw-w64 installation folder e.g. `C:\Program Files\mingw-w64\x86_64-8.1.0-win32-seh-rt_v6-rev0\mingw64` and `C:\Program Files\mingw-w64\x86_64-8.1.0-win32-seh-rt_v6-rev0\mingw64\x86_64-w64-mingw32`
3. Setup Path environment variable
    * Put your mingw-w64 binaries location into your system Path environment variable. e.g. `C:\Program Files\mingw-w64\x86_64-8.1.0-win32-seh-rt_v5-rev0\mingw64\bin` and `C:\Program Files\mingw-w64\x86_64-8.1.0-win32-seh-rt_v5-rev0\mingw64\x86_64-w64-mingw32\bin`
4. Open up a terminal and run `go get -v github.com/veandco/go-sdl2/sdl`.
